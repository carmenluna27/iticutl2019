...
function status(concecutivo,id){
   ...
   var nomPersona    = "#tPersona"+concecutivo;
   var nomUsuario = "#tUsuario"+concecutivo;
   var fRegistro  = "#tRegistro"+concecutivo;
   ...
   if( $(nomToggle).is(':checked') ) {
       ...
       $(nomPersona).removeClass("desabilita");
       $(nomUsuario).removeClass("desabilita");
       $(fRegistro).removeClass("desabilita");
   }else{
       ...
       $(nomPersona).addClass("desabilita");
       $(nomUsuario).addClass("desabilita");
       $(fRegistro).addClass("desabilita");
   }
