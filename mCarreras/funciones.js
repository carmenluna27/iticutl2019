...
function status(concecutivo,id){
   ...
   var nomCarrera    = "#tCarrera"+concecutivo;
   var nomAbreviatura = "#tAbreviatura"+concecutivo;
//    var carrera  = "#tCarrera"+concecutivo;
   ...
   if( $(nomToggle).is(':checked') ) {
       ...
       $(nomCarrera).removeClass("desabilita");
       $(nomAbreviatura).removeClass("desabilita");
    //    $(carrera).removeClass("desabilita");
       ...
       $(nomCarrera).addClass("desabilita");
       $(nomAbreviatura).addClass("desabilita");
